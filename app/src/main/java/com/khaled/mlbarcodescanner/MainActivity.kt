...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupCamera(findViewById(R.id.preview_view))
    }
    ...
    private fun processImageProxy(
        ...
        barcodeScanner.process(inputImage)
            .addOnSuccessListener { barcodes ->
                barcodes.forEach {
                    if (it.valueType == Barcode.TYPE_DRIVER_LICENSE) {
                        parseBarcodeData(it.rawValue)
                    }
                }
            }
            .addOnFailureListener {
                Log.e("FOXX ERROR", it.message)
    ...
    private fun parseBarcodeData(barcodeString: String){
        for (line in barcodeString.lines()) {
            Log.i("RAW BARCODE", line)
        }
